...
- 4장. 통합 테스트란? / 5장. 통합 테스트 작성하기
  ...
  - 정답: [`shopping-mall-integration-test-with-answer`]([shopping-mall-integration-test-with-answer](https://github.com/practical-fe-testing/test-example-shopping-mall/tree/shopping-mall-integration-test-with-answer))
